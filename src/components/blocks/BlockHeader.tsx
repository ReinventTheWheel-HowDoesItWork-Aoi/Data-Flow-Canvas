...
const iconMap: Record<BlockType, string> = {
  ...
  'fuzzy-join': 'GitMerge',
  'memory-optimizer': 'Cpu',
  'cyclical-time-encoder': 'Clock',
  'geographic-distance': 'MapPin',
  'rare-category-combiner': 'Layers',
  'smart-auto-cleaner': 'Sparkles',
  'interaction-generator': 'Sigma',
  'fuzzy-deduplicator': 'Copy',
  'array-aggregator': 'Layers',
  'target-aware-binning': 'BarChart',
  ...
  'comprehensive-eda': 'FileBarChart',
  'shap-deep-explainer': 'Lightbulb',
  'stl-decomposition': 'Waves',
  'multi-algorithm-anomaly': 'AlertTriangle',
  'automated-feature-pipeline': 'Sparkles',
  'distribution-drift-monitor': 'GitCompare',
  'smart-resampling': 'Scale',
  'collinearity-diagnostics': 'GitMerge',
  'bayesian-ab-calculator': 'FlaskConical',
  'nested-cross-validation': 'Repeat',
  // New Pyodide-Compatible Analysis Blocks (December 2025)
  'gaussian-mixture-model': 'Circle',
  'dynamic-time-warping': 'Activity',
  'lime-explainer': 'Lightbulb',
  'bayesian-optimization': 'Target',
  'time-series-features': 'Clock',
  'robust-regression': 'Shield',
  'kernel-density-estimation': 'Waves',
  'spectral-clustering': 'Network',
  'cross-correlation': 'ArrowRightLeft',
  'manifold-learning': 'Minimize2',
  'semi-supervised-learning': 'Users',
  'multi-label-classification': 'Tags',
  'conformal-prediction': 'Shield',
  'one-class-svm': 'ShieldAlert',
  'elliptic-envelope': 'Circle',
  'isotonic-regression': 'TrendingUp',
  'power-transform': 'Zap',
  'mutual-information-selection': 'Sparkles',
  'sequential-feature-selection': 'ListFilter',
  'permutation-importance': 'Shuffle',
  'acf-pacf-analysis': 'Activity',
  'stationarity-testing': 'Scale',
  'exponential-smoothing': 'TrendingUp',
  'copula-analysis': 'Link',
  'variance-threshold': 'Filter',
  'hierarchical-clustering': 'GitMerge',
  'chart': 'PieChart',
  'table': 'Table',
  ...
  'shap-summary-plot': 'Lightbulb',
  'partial-dependence-plot': 'TrendingUp',
  'feature-importance-plot': 'Award',
  'ice-plot': 'Activity',
  'precision-recall-curve': 'Target',
  'learning-curve-plot': 'TrendingUp',
  'residual-plot': 'ScatterChart',
  'actual-vs-predicted-plot': 'GitCompare',
  'calibration-curve': 'Target',
  'lift-chart': 'TrendingUp',
  'elbow-plot': 'GitBranch',
  'silhouette-plot': 'Layers',
  'tsne-umap-plot': 'ScatterChart',
  'missing-value-heatmap': 'Grid',
  'outlier-detection-plot': 'AlertTriangle',
  'distribution-comparison-plot': 'Layers',
  'ecdf-plot': 'TrendingUp',
  'andrews-curves': 'Waves',
  'cv-results-plot': 'BarChart3',
  'hyperparameter-heatmap': 'Grid',
  'export': 'Download',
};
