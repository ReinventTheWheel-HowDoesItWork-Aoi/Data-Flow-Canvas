...
const blocks: BlockInfo[] = [
  ...
  { icon: AlertTriangle, name: 'Isolation Forest', description: 'Detect anomalies using Isolation Forest algorithm', category: 'Analysis' },
  { icon: TrendingUp, name: 'ARIMA Forecasting', description: 'Time series forecasting using ARIMA/SARIMA models', category: 'Analysis' },
  { icon: Layers, name: 'Seasonal Decomposition', description: 'Decompose time series into trend, seasonal, and residual components', category: 'Analysis' },
  { icon: Shuffle, name: 'Monte Carlo Simulation', description: 'Run Monte Carlo simulations for risk analysis and uncertainty quantification', category: 'Analysis' },
  { icon: GitMerge, name: 'Propensity Score Matching', description: 'Match treatment and control groups for causal inference', category: 'Analysis' },
  { icon: GitCompare, name: 'Difference-in-Differences', description: 'Estimate causal effects using difference-in-differences analysis', category: 'Analysis' },
  { icon: Layers, name: 'Factor Analysis', description: 'Discover latent factors underlying observed variables', category: 'Analysis' },
  { icon: Network, name: 'DBSCAN Clustering', description: 'Density-based clustering that identifies outliers automatically', category: 'Analysis' },
  { icon: TrendingUp, name: 'Elastic Net Regression', description: 'Regularized regression combining L1 and L2 penalties', category: 'Analysis' },
  { icon: Activity, name: 'Vector Autoregression (VAR)', description: 'Multivariate time series analysis for interdependent variables', category: 'Analysis' },
  { icon: GitBranch, name: 'Interrupted Time Series', description: 'Analyze the impact of interventions on time series data', category: 'Analysis' },
  { icon: GitCompare, name: 'Granger Causality Test', description: 'Test whether one time series helps predict another', category: 'Analysis' },
  { icon: AlertTriangle, name: 'Local Outlier Factor', description: 'Detect local outliers based on density deviation from neighbors', category: 'Analysis' },
  { icon: Filter, name: 'Feature Selection', description: 'Select most predictive features using RFE, SelectKBest, or Mutual Information', category: 'Analysis' },
  { icon: AlertTriangle, name: 'Outlier Treatment', description: 'Cap, remove, or impute outliers using IQR, Z-score, or percentile methods', category: 'Analysis' },
  { icon: GitCompare, name: 'Data Drift Detection', description: 'Detect distribution shifts between reference and current data using KS-test and PSI', category: 'Analysis' },
  { icon: TrendingUp, name: 'Polynomial Features', description: 'Create polynomial and interaction features from numeric columns', category: 'Analysis' },
  { icon: GitFork, name: 'Multi-Output Prediction', description: 'Predict multiple target variables simultaneously', category: 'Analysis' },
  { icon: Gauge, name: 'Probability Calibration', description: 'Calibrate classifier probabilities using Platt scaling or isotonic regression', category: 'Analysis' },
  { icon: Minimize2, name: 't-SNE Reduction', description: 'Reduce high-dimensional data to 2D/3D using t-SNE for visualization', category: 'Analysis' },
  { icon: FlaskConical, name: 'Statistical Tests Suite', description: 'Perform various statistical tests: Mann-Whitney, Wilcoxon, Kruskal-Wallis, Levene', category: 'Analysis' },
  { icon: BarChart, name: 'Optimal Binning', description: 'Create optimal bins using decision tree or quantile-based methods with WoE/IV', category: 'Analysis' },
  { icon: LinkIcon, name: 'Correlation Finder', description: 'Find highly correlated pairs and identify multicollinearity issues', category: 'Analysis' },
  ...
  { icon: Box, name: 'Box Plot', description: 'Statistical distribution showing median, quartiles, and outliers', category: 'Visualization' },
  { icon: Grid3x3, name: 'Heatmap', description: 'Matrix visualization with color intensity representing values', category: 'Visualization' },
  { icon: Map, name: 'Scatter Map', description: 'Geographic points plotted on a map using latitude/longitude', category: 'Visualization' },
  { icon: BarChart3, name: 'Grouped Histogram', description: 'Compare distributions across categories with overlapping histograms', category: 'Visualization' },
  { icon: Network, name: 'Network Graph', description: 'Force-directed graph showing relationships between nodes', category: 'Visualization' },
  { icon: Calendar, name: 'Calendar Heatmap', description: 'Daily values displayed in a calendar grid format', category: 'Visualization' },
  { icon: LayoutGrid, name: 'Faceted Chart', description: 'Same chart repeated across categories for comparison', category: 'Visualization' },
  { icon: Activity, name: 'Density Plot', description: 'Smooth probability density curve using kernel density estimation', category: 'Visualization' },
  { icon: BarChart3, name: 'Error Bar Chart', description: 'Bar or line chart with confidence intervals or error bars', category: 'Visualization' },
  { icon: Circle, name: 'Dot Plot', description: 'Cleveland dot plot for clean categorical value comparison', category: 'Visualization' },
  { icon: TrendingUp, name: 'Slope Chart', description: 'Before/after comparison showing changes between two points', category: 'Visualization' },
  { icon: BarChart3, name: 'Grouped Bar Chart', description: 'Side-by-side bars comparing subcategories within groups', category: 'Visualization' },
  { icon: TrendingUp, name: 'Bump Chart', description: 'Ranking changes over time with connected lines', category: 'Visualization' },
  { icon: PieChart, name: 'Donut Chart', description: 'Pie chart with hollow center for proportions and center KPI display', category: 'Visualization' },
  { icon: BarChart3, name: 'Horizontal Bar Chart', description: 'Horizontal bars for categorical comparisons with long labels', category: 'Visualization' },
  { icon: ScatterChart, name: '3D Scatter Plot', description: 'Interactive 3D scatter visualization with rotation and zoom', category: 'Visualization' },
  { icon: Activity, name: 'Contour Plot', description: '2D density visualization showing concentration areas with contour lines', category: 'Visualization' },
  { icon: Grid3x3, name: 'Hexbin Plot', description: 'Hexagonal binning for large scatter datasets to prevent overplotting', category: 'Visualization' },
  { icon: Layers, name: 'Ridge Plot', description: 'Stacked density curves comparing distributions across categories', category: 'Visualization' },
  { icon: Circle, name: 'Strip Plot', description: 'Individual data points with jitter along categorical axis', category: 'Visualization' },
  { icon: Target, name: 'Bullet Chart', description: 'Compact KPI visualization showing actual vs target with qualitative ranges', category: 'Visualization' },
  { icon: BarChart3, name: 'Pyramid Chart', description: 'Back-to-back horizontal bars for two-sided population comparisons', category: 'Visualization' },
  { icon: Calendar, name: 'Timeline Chart', description: 'Events and tasks displayed along a time axis with duration bars', category: 'Visualization' },
...
const blockTranslationKeys: Record<string, { name: string; description: string }> = {
  ...
  'One-Hot Encode': { name: 'blocks.oneHotEncode', description: 'blockDescriptions.oneHotEncode' },
  'Label Encode': { name: 'blocks.labelEncode', description: 'blockDescriptions.labelEncode' },
  'Ordinal Encode': { name: 'blocks.ordinalEncode', description: 'blockDescriptions.ordinalEncode' },
  'Min-Max Normalize': { name: 'blocks.minMaxNormalize', description: 'blockDescriptions.minMaxNormalize' },
  'Z-Score Standardize': { name: 'blocks.zScoreStandardize', description: 'blockDescriptions.zScoreStandardize' },
  'Rolling Statistics': { name: 'blocks.rollingStatistics', description: 'blockDescriptions.rollingStatistics' },
  'Resample Time Series': { name: 'blocks.resampleTimeseries', description: 'blockDescriptions.resampleTimeseries' },
  'Regex Replace': { name: 'blocks.regexReplace', description: 'blockDescriptions.regexReplace' },
  'Expand JSON Column': { name: 'blocks.expandJsonColumn', description: 'blockDescriptions.expandJsonColumn' },
  'Add Unique ID': { name: 'blocks.addUniqueId', description: 'blockDescriptions.addUniqueId' },
  'Missing Value Indicator': { name: 'blocks.missingIndicator', description: 'blockDescriptions.missingIndicator' },
  'Quantile Transform': { name: 'blocks.quantileTransform', description: 'blockDescriptions.quantileTransform' },
  'Fuzzy Join': { name: 'blocks.fuzzyJoin', description: 'blockDescriptions.fuzzyJoin' },
  'Memory Optimizer': { name: 'blocks.memoryOptimizer', description: 'blockDescriptions.memoryOptimizer' },
  'Cyclical Time Encoder': { name: 'blocks.cyclicalTimeEncoder', description: 'blockDescriptions.cyclicalTimeEncoder' },
  'Geographic Distance': { name: 'blocks.geographicDistance', description: 'blockDescriptions.geographicDistance' },
  'Rare Category Combiner': { name: 'blocks.rareCategoryCombiner', description: 'blockDescriptions.rareCategoryCombiner' },
  'Smart Auto-Cleaner': { name: 'blocks.smartAutoCleaner', description: 'blockDescriptions.smartAutoCleaner' },
  'Interaction Generator': { name: 'blocks.interactionGenerator', description: 'blockDescriptions.interactionGenerator' },
  'Fuzzy Deduplicator': { name: 'blocks.fuzzyDeduplicator', description: 'blockDescriptions.fuzzyDeduplicator' },
  'Array Aggregator': { name: 'blocks.arrayAggregator', description: 'blockDescriptions.arrayAggregator' },
  'Target-Aware Binning': { name: 'blocks.targetAwareBinning', description: 'blockDescriptions.targetAwareBinning' },
  ...
  'Isolation Forest': { name: 'blocks.isolationForest', description: 'blockDescriptions.isolationForest' },
  'ARIMA Forecasting': { name: 'blocks.arimaForecasting', description: 'blockDescriptions.arimaForecasting' },
  'Seasonal Decomposition': { name: 'blocks.seasonalDecomposition', description: 'blockDescriptions.seasonalDecomposition' },
  'Monte Carlo Simulation': { name: 'blocks.monteCarloSimulation', description: 'blockDescriptions.monteCarloSimulation' },
  'Propensity Score Matching': { name: 'blocks.propensityScoreMatching', description: 'blockDescriptions.propensityScoreMatching' },
  'Difference-in-Differences': { name: 'blocks.differenceInDifferences', description: 'blockDescriptions.differenceInDifferences' },
  'Factor Analysis': { name: 'blocks.factorAnalysis', description: 'blockDescriptions.factorAnalysis' },
  'DBSCAN Clustering': { name: 'blocks.dbscanClustering', description: 'blockDescriptions.dbscanClustering' },
  'Elastic Net Regression': { name: 'blocks.elasticNet', description: 'blockDescriptions.elasticNet' },
  'Vector Autoregression (VAR)': { name: 'blocks.varAnalysis', description: 'blockDescriptions.varAnalysis' },
  'Interrupted Time Series': { name: 'blocks.interruptedTimeSeries', description: 'blockDescriptions.interruptedTimeSeries' },
  'Granger Causality Test': { name: 'blocks.grangerCausality', description: 'blockDescriptions.grangerCausality' },
  'Local Outlier Factor': { name: 'blocks.localOutlierFactor', description: 'blockDescriptions.localOutlierFactor' },
  'Feature Selection': { name: 'blocks.featureSelection', description: 'blockDescriptions.featureSelection' },
  'Outlier Treatment': { name: 'blocks.outlierTreatment', description: 'blockDescriptions.outlierTreatment' },
  'Data Drift Detection': { name: 'blocks.dataDrift', description: 'blockDescriptions.dataDrift' },
  'Polynomial Features': { name: 'blocks.polynomialFeatures', description: 'blockDescriptions.polynomialFeatures' },
  'Multi-Output Prediction': { name: 'blocks.multiOutput', description: 'blockDescriptions.multiOutput' },
  'Probability Calibration': { name: 'blocks.probabilityCalibration', description: 'blockDescriptions.probabilityCalibration' },
  't-SNE Reduction': { name: 'blocks.tsneReduction', description: 'blockDescriptions.tsneReduction' },
  'Statistical Tests Suite': { name: 'blocks.statisticalTests', description: 'blockDescriptions.statisticalTests' },
  'Optimal Binning': { name: 'blocks.optimalBinning', description: 'blockDescriptions.optimalBinning' },
  'Correlation Finder': { name: 'blocks.correlationFinder', description: 'blockDescriptions.correlationFinder' },
  ...
  'Box Plot': { name: 'blocks.boxPlot', description: 'blockDescriptions.boxPlot' },
  'Heatmap': { name: 'blocks.heatmap', description: 'blockDescriptions.heatmap' },
  'Scatter Map': { name: 'blocks.scatterMap', description: 'blockDescriptions.scatterMap' },
  'Grouped Histogram': { name: 'blocks.groupedHistogram', description: 'blockDescriptions.groupedHistogram' },
  'Network Graph': { name: 'blocks.networkGraph', description: 'blockDescriptions.networkGraph' },
  'Calendar Heatmap': { name: 'blocks.calendarHeatmap', description: 'blockDescriptions.calendarHeatmap' },
  'Faceted Chart': { name: 'blocks.facetedChart', description: 'blockDescriptions.facetedChart' },
  'Density Plot': { name: 'blocks.densityPlot', description: 'blockDescriptions.densityPlot' },
  'Error Bar Chart': { name: 'blocks.errorBarChart', description: 'blockDescriptions.errorBarChart' },
  'Dot Plot': { name: 'blocks.dotPlot', description: 'blockDescriptions.dotPlot' },
  'Slope Chart': { name: 'blocks.slopeChart', description: 'blockDescriptions.slopeChart' },
  'Grouped Bar Chart': { name: 'blocks.groupedBarChart', description: 'blockDescriptions.groupedBarChart' },
  'Bump Chart': { name: 'blocks.bumpChart', description: 'blockDescriptions.bumpChart' },
  'Donut Chart': { name: 'blocks.donutChart', description: 'blockDescriptions.donutChart' },
  'Horizontal Bar Chart': { name: 'blocks.horizontalBarChart', description: 'blockDescriptions.horizontalBarChart' },
  '3D Scatter Plot': { name: 'blocks.scatter3d', description: 'blockDescriptions.scatter3d' },
  'Contour Plot': { name: 'blocks.contourPlot', description: 'blockDescriptions.contourPlot' },
  'Hexbin Plot': { name: 'blocks.hexbinPlot', description: 'blockDescriptions.hexbinPlot' },
  'Ridge Plot': { name: 'blocks.ridgePlot', description: 'blockDescriptions.ridgePlot' },
  'Strip Plot': { name: 'blocks.stripPlot', description: 'blockDescriptions.stripPlot' },
  'Bullet Chart': { name: 'blocks.bulletChart', description: 'blockDescriptions.bulletChart' },
  'Pyramid Chart': { name: 'blocks.pyramidChart', description: 'blockDescriptions.pyramidChart' },
  'Timeline Chart': { name: 'blocks.timelineChart', description: 'blockDescriptions.timelineChart' },
