...
const blockTranslationKeys: Record<string, { name: string; description: string }> = {
  ...
  'Elastic Net Regression': { name: 'blocks.elasticNetRegression', description: 'blockDescriptions.elasticNetRegression' },
  ...
  'Data Drift Detection': { name: 'blocks.dataDriftDetection', description: 'blockDescriptions.dataDriftDetection' },
  'Polynomial Features': { name: 'blocks.polynomialFeatures', description: 'blockDescriptions.polynomialFeatures' },
  'Multi-Output Prediction': { name: 'blocks.multiOutputPrediction', description: 'blockDescriptions.multiOutputPrediction' },
  ...
  'Statistical Tests Suite': { name: 'blocks.statisticalTestsSuite', description: 'blockDescriptions.statisticalTestsSuite' },
